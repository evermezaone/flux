...
class AdminPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            // Sin FilamentInfoWidget: mostraba la version del framework (ej. v5.6.7) y se
            // confundia con la version de la app. La version real de FLUX va en el footer (REQ-0017).
            ->widgets([
                AccountWidget::class,
            ])
            ->middleware([
